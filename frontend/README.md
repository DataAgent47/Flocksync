...
- For manual building ownership verification, verifying or rejecting is done by manually going into firebase console and editing the verificationStatus field to either "verified" or "rejected" for the respective decisions.
- To see the uploaded documents, go into the supabase project -> buckets -> verification-documents. The first level is the firebase UID of the user. From there you can see all of the documents they uploaded.
